            ...
            <div className={`${styles['view-width']}`}>
                <div className={`${styles['product-section-header']}`}>
                    <div>
                        ...
                        <p className={`${styles['home-subtitle-product']}`}>Đối tác chuyên nghiệp được Wedtech thẩm định năng lực.</p>
                    </div>
                ...
                <div className={`${styles['product-grid']}`}>
                    ...
                    <div className={`${styles['product-card']}`}>
                        <span className={`${styles['product-image-authenticate']}`}>Đã xác thực</span>
                        <img src={weddingitems} alt="Lại Phương Hiền" className={`${styles['product-card-image']}`} />
                        <div className={`${styles['product-card-content']}`}>
                            <h3 className={`${styles['product-card-name']}`}>Lại Phương Hiền (Kho Đồ Cưới)</h3>
                    ...
                    <div className={`${styles['product-card']}`}>
                        <span className={`${styles['product-image-authenticate']}`}>Đã xác thực</span>
                        <img src={SOUNDLIGHTING} alt="Lại Phương Hiền" className={`${styles['product-card-image']}`} />
                        <div className={`${styles['product-card-content']}`}>
                            <h3 className={`${styles['product-card-name']}`}>Công ty TNHH CÔNG NGHỆ ÂM THANH ÁNH SÁNG H&A VIỆT NAM</h3>
                    ...
                    <div className={`${styles['product-card']}`}>
                        <span className={`${styles['product-image-authenticate']}`}>Đã xác thực</span>
                        <img src={GREENSOUNDGROUP} alt="Lại Phương Hiền" className={`${styles['product-card-image']}`} />
                        <div className={`${styles['product-card-content']}`}>
                            <h3 className={`${styles['product-card-name']}`}>CÔNG TY TNHH GREEN SOUND GROUP</h3>
                    ...
                    <div className={`${styles['product-card']}`}>
                        <span className={`${styles['product-image-authenticate']}`}>Đã xác thực</span>
                        <img src={Homies} alt="Lại Phương Hiền" className={`${styles['product-card-image']}`} />
                        <div className={`${styles['product-card-content']}`}>
                            <h3 className={`${styles['product-card-name']}`}>Công ty TNHH Homies Live Viet Nam</h3>
