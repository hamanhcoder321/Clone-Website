...
const statsData = [
    { icon: UsersIcon, number: "2.500+", title: "Nhà cung cấp đã xác thực" },
    { icon: StarIcon, number: "850", title: "Đơn vị đã xác thực" },
    { icon: CalendarIcon, number: "12.000+", title: "Sự kiện thành công" },
    { icon: MapIcon, number: "34", title: "Tỉnh thành toàn quốc" }
];
            ...
            <div className="home-hero-stats">
                <div className="stats-grid">
                    {statsData.map((stat, idx) => (
                        <StatCard key={idx} {...stat} index={idx + 1} />
                    ))}
                </div>
            </div>
        </div>
