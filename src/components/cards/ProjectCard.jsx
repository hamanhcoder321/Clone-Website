...
export default function ProjectCard({ data }) {
    return (
        <div className={`${styles['product-card']}`}>
            <span className={`${styles['product-image-label']}`}>{data.imageLabel}</span>
            ...
            <div className={`${styles['product-card-content']}`}>
                ...
                {/* Company Name */}
                <div className={`${styles['product-card-custome']}`}>
                    ...
                    <span className={`${styles['custome']}`}>{data.customerName}</span>
                </div>
                ...
                <div className={`${styles['product-card-meta']}`}>
                    ...
                    <span className={`${styles['product-card-guests']}`}>
                            ...
                            return (
                                <div key={idx} style={{ display: 'flex', flexWrap: 'nowrap', gap: '2px', width: '55%' }}>
                                    {badgeItem.map((bage, i) => (
                                        <span key={i} className={`${styles['product-badge']}`}>
